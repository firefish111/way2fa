// Package containing utilities to manage the available stores.
// This includes viewing them, and converting between them.
// Most of these are thin wrappers around internal/ui/manager
package manager
